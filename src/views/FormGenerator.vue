    ...
    <div class="subContainer">
        ...
        <div v-if="!isPreview" class="container">
            ...
            <div v-for="(css, index) in allCss" :key="css" class="inputContainer">
                <div class="cssContainer">
                    <InputText placeholder="Enter css URL" class="p-input" type="text" :key="index" v-model="css.css" />
        ...
        <div v-if="!isPreview" class="container">
            ...
            <div v-for="(js, index) in allJs" :key="js" class="inputContainer">
                <div class="cssContainer">
                    <InputText v-model="js.js" placeholder="Enter js URL" class="p-input" :key="index" type="text" />
          ...
          >
            ...
            >
              ...
              <div class="optionButton">
                ...
                <Button @click="closeModel" class="p-closeModel"
                  >Close Model</Button
                >
              </div>
